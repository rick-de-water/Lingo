...
function(unicode_generate_mapping_header FROM TO FROM_NAME TO_NAME OUTPUT_VARIABLE)
	...
	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t minor_table_${FROM_NAME}_${TO_NAME}_empty[${MINOR_TABLE_SIZE}] = ${MINOR_TABLE_ARRAY};\n")
	...
	foreach(MINOR_TABLE_INDEX RANGE ${MINOR_TABLE_RANGE})
		if (DEFINED "MINOR_TABLE_${MINOR_TABLE_INDEX}")
			...
			string(APPEND HEADER "\t\t\tconstexpr uint_least32_t minor_table_${FROM_NAME}_${TO_NAME}_${MINOR_TABLE_INDEX}[${MINOR_TABLE_SIZE}] = ${MINOR_TABLE_ARRAY};\n")
		endif()
	endforeach()
	string(APPEND HEADER "\n")

	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t point_start_index_${FROM_NAME}_${TO_NAME} = ${POINT_INDEX_START};\n")
	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t point_end_index_${FROM_NAME}_${TO_NAME} = ${POINT_INDEX_END};\n\n")

	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t minor_table_start_index_${FROM_NAME}_${TO_NAME} = ${MINOR_TABLE_START};\n")
	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t minor_table_end_index_${FROM_NAME}_${TO_NAME} = ${MINOR_TABLE_END};\n")
	string(APPEND HEADER "\t\t\tconstexpr uint_least32_t minor_table_count_${FROM_NAME}_${TO_NAME} = ${MINOR_TABLE_COUNT};\n\n")

	string(APPEND HEADER "\t\t\tconstexpr const uint_least32_t* major_table_${FROM_NAME}_${TO_NAME}[${MINOR_TABLE_COUNT}] = { ")
	foreach(MINOR_TABLE_INDEX RANGE ${MINOR_TABLE_RANGE})
		if (DEFINED "MINOR_TABLE_${MINOR_TABLE_INDEX}")
			string(APPEND HEADER "minor_table_${FROM_NAME}_${TO_NAME}_${MINOR_TABLE_INDEX}, ")
		else()
			string(APPEND HEADER "minor_table_${FROM_NAME}_${TO_NAME}_empty, ")
		endif()
	endforeach()
	string(APPEND HEADER "};\n")
